...
import br.ufrgs.inf.rlnunes.dicepocketv1.util.SystemUiHider;
...
public class RollDiceActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addDiceBtn = (Button) findViewById(R.id.buttonAddDice);
        ...
        //Read more: http://www.javaexperience.com/how-to-create-a-dynamically-growing-listview-in-android/#ixzz3cWI2LthT

        //DiceView dv = new DiceView(R.layout.activity_roll_dice);
        //dv.setAmount(5);
        //dv.setnFaces(20);
        //listView.addView(dv);
